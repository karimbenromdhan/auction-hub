...
function UserDropdownMenu({
  ...
  return (
    <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <Button
        onClick={onLogout}
        className="w-full px-4 py-2.5 text-left text-sm font-medium text-red-600 hover:bg-red-50 hover:text-black transition-colors flex items-center gap-2 mt-1"
      >
        <svg
          className="w-4 h-4"
          fill="none"
