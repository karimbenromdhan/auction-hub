...
function ViewAllAuctionsButton() {
  return (
    <Link to={ROUTES.AUCTIONS}>
      ...
      >
        <DecorativeLayer className="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-indigo-600/5 transform -skew-x-12 -translate-x-full group-hover/view:translate-x-full transition-transform duration-700" />
        <Text as="span" className="relative flex items-center gap-2 font-semibold">
