...
function SignUpButton() {
  return (
    <Link to={ROUTES.REGISTER}>
      ...
      >
        <DecorativeLayer className="absolute inset-0 bg-white/20 transform -skew-x-12 -translate-x-full group-hover/signup:translate-x-full transition-transform duration-700" />
