...
import { LiveBadge, HeroHeading, HeroCTAButtons, HeroStats } from '../../molecules';
...
function HeroContent({ activeAuctionsCount = 0 }: HeroContentProps) {
  return (
    <div className="max-w-2xl">
      ...
      <Text as="p" className="text-xl text-blue-100 mb-8 leading-relaxed max-w-xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
