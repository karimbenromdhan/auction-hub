  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
      <Link to={ROUTES.AUCTIONS}>
        ...
        >
          <DecorativeLayer className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10 transform -skew-x-12 -translate-x-full group-hover/cta:translate-x-full transition-transform duration-700" />
          <Text as="span" className="relative flex items-center gap-2 font-semibold text-blue-600">
      ...
      <Link to={ROUTES.CREATE_AUCTION}>
        ...
        >
          <Text as="span" className="flex items-center gap-2 font-semibold">
