    ...
    <div className="relative bg-gradient-to-br from-white via-blue-50/20 to-indigo-50/30 py-20 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <Text
            variant="h2"
            className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent font-bold mb-4"
          >
            Everything You Need to Bid & Win
          </Text>
          <Text as="p" className="text-gray-600 max-w-2xl mx-auto text-lg">
            Experience the most advanced auction platform with real-time
            bidding, secure transactions, and an intuitive interface.
          </Text>
        </div>
