import { Text, Button, DecorativeLayer } from '../../atoms';
      ...
      <div className="flex justify-center items-center gap-4 mt-16 pt-8 border-t border-gray-200">
        ...
        >
          <Text as="span" className="flex items-center gap-2 font-medium">
            <svg
              className="w-4 h-4 group-hover/prev:-translate-x-1 transition-transform duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="relative group">
          <DecorativeLayer className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl blur opacity-20 group-hover:opacity-30 transition-opacity" />
          <div className="relative flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-xl border border-blue-200 shadow-md">
            ...
            <Text as="span" className="text-gray-400 font-medium">
              of
            </Text>
            <Text variant="body" weight="bold" className="text-gray-800">
              {totalPages}
        ...
        >
          <Text as="span" className="flex items-center gap-2 font-medium">
            Next
            <svg
              className="w-4 h-4 group-hover/next:translate-x-1 transition-transform duration-200"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
